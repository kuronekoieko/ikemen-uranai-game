...
namespace Mopsicus.Plugins
{
    ...
    public class MobileInputField_TMP : MobileInputReceiver
    {
        ...
        /// <summary>
        /// TMP_Text object from _inputObject
        /// </summary>
                    ...
                    for (int i = 0; i < touchCount; i++) {
                        if (!inputRect.Contains (Input.GetTouch(i).position)) {
                            if (!IsManualHideControl) {
                               ...
                               // このreturnをコメントしないと、スクロールビューで位置が追従しない
                            // return;
                        }
                    }
                }
